...
func New(cfg config.Config, container bootstrap.Container) http.Handler {
	...
	mux.HandleFunc("GET "+cfg.APIV1Prefix+"/audit-events", auditEventHandler.List)
	mux.HandleFunc("GET "+cfg.APIV1Prefix+"/audit-events/summary", auditEventHandler.Summary)
